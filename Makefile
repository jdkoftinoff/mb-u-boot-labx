...
GEN_UBOOT = \
		...
		cd $(LNDIR) && $(LD) $(LDFLAGS) $$UNDEF_SYM $(__OBJS) \
			--start-group $(__LIBS) $(PLATFORM_LIBS) --end-group \
...
meyer_sound_CAL_ICS_REGULAR_config: unconfig
	@mkdir -p $(obj)include
	@$(MKCONFIG) -a $(@:_config=) microblaze microblaze CAL_ICS_REGULAR meyer_sound
